...
function graph_draw_grid(c, data)
{
    ...
    c.fillStyle = opt.color.axe;
    c.font = "bold 12px DejaVu Sans";
    c.fillText(data.comment[0], 5, opt.height-15);
    c.fillText(data.comment[1], opt.width/2-(data.comment[1].length*8), opt.height-15);
    c.fillText(data.comment[2], opt.width-(data.comment[2].length*8), opt.height-15);
    c.fill();
    c.restore();
}
...
function drawGridX(c, l) {
    ...
    for(var i=0; i<l.length; i++) {
        ...
        c.fillText(l[i][1], g1[0]+l[i][0]-(l[i][1].length*8)/2, g1[1]+g1[3]+8);
    }
    c.stroke();
...
function drawGridY(c, l) {
    ...
    for(var i=0; i<l.length-1; i++) {
        ...
        c.fillText(l[i][1], 10, g1[3]+g1[1]-l[i][0]-6);
        c.fillText(l[i][2], g1[0]+g1[2]+10, g1[3]+g1[1]-l[i][0]-8)
    }
    c.moveTo(g1[0]-5,       g1[3]+g1[1]-l[i][0]);
    c.lineTo(g1[0]+g1[2]+5, g1[3]+g1[1]-l[i][0]);
    c.font = "bold 18px DejaVu Sans";
    c.fillStyle = opt.color.y[0];
    c.fillText(l[i][1], 10, g1[3]+g1[1]-l[i][0]-10);
    c.fillStyle = opt.color.y[1];
    c.fillText(l[i][2], g1[0]+g1[2]+10, g1[3]+g1[1]-l[i][0]-10);
    c.stroke();
...
function drawGridZ(c, l) {
    ...
    /* draw labels */
    c.font = "bold 11px DejaVu Sans";
    c.fillStyle = opt.color.grid;
    for (var i=0; i<l.length; i++) {
        c.moveTo(g2[0]-5,                  g2[1]+12*i);
        c.lineTo(g2[0]+g2[2]+5,            g2[1]+12*i);
        c.fillText(l[i][1], 5,             g2[1]+12*i);
        c.fillText(l[i][2], g2[0]+g2[2]+10, g2[1]+12*i);
    }
    c.moveTo(g2[0]-5,                    g2[1]+12*i);
    c.lineTo(g2[0]+g2[2]+5,              g2[1]+12*i);
    c.stroke();
